sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("itsgrp.OrdensDeVendas.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias itsgrp.OrdensDeVendas.controller.ListSelector
			 */
			 ...
			 * @return {itsgrp.OrdensDeVendas.model.ListSelector} the list selector object for method chaining
			 * @public
			 */

sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("itsgrp/OrdensDeVendas/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("itsgrp.OrdensDeVendas.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["itsgrp/OrdensDeVendas/localService/mockserver"], function (mockserver) {
